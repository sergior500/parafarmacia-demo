...
| Área           | Decisión necesaria                        | Objetivo                     |
| -------------- | ----------------------------------------- | ---------------------------- |
...
| Autenticación  | Proveedor de identidad                    | Acceso seguro al panel       |
| Persistencia   | Base de datos y copias                    | Pedidos y auditoría          |

La implementación debe mantener los puertos actuales y sustituir un adaptador
de cada vez, con pruebas de contrato y un entorno de ensayo.
